...
private:
    ...
    */
    ...
    /*
        gets the pointer to the deepest node in a complete binary tree (rightmost node in the lowest level)
        @param @param root, pointer to the root of the subtree to traverse
        @return pointer to the deepest node
    */
